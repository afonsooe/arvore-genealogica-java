...
public class ArvoreGenealogica {
    ...
    public static void main(String[] args) {
        ...
        DefaultMutableTreeNode raiz =
                new DefaultMutableTreeNode("Dom Pedro II");

        // Criando os pais (nível 2)
        DefaultMutableTreeNode pai =
                new DefaultMutableTreeNode("Dom Pedro I");

        DefaultMutableTreeNode mae =
                new DefaultMutableTreeNode("Maria Leopoldina");
        ...
        // Avós paternos
        DefaultMutableTreeNode avoP1 =
                new DefaultMutableTreeNode("Dom João VI");

        DefaultMutableTreeNode avoP2 =
                new DefaultMutableTreeNode("Carlota Joaquina");

        // Avós maternos
        DefaultMutableTreeNode avoM1 =
                new DefaultMutableTreeNode("Francisco I da Áustria");

        DefaultMutableTreeNode avoM2 =
                new DefaultMutableTreeNode("Maria Teresa das Duas Sicílias");
        ...
        // Bisavós (nível 4)
        DefaultMutableTreeNode bis1 =
                new DefaultMutableTreeNode("Pedro III de Portugal");

        DefaultMutableTreeNode bis2 =
                new DefaultMutableTreeNode("Maria I de Portugal");

        avoP1.add(bis1);
        avoP1.add(bis2);

        DefaultMutableTreeNode bis3 =
                new DefaultMutableTreeNode("Carlos IV da Espanha");

        DefaultMutableTreeNode bis4 =
                new DefaultMutableTreeNode("Maria Luísa de Parma");

        avoP2.add(bis3);
        avoP2.add(bis4);

        DefaultMutableTreeNode bis5 =
                new DefaultMutableTreeNode("Leopoldo II");

        DefaultMutableTreeNode bis6 =
                new DefaultMutableTreeNode("Maria Luísa da Espanha");

        avoM1.add(bis5);
        avoM1.add(bis6);

        DefaultMutableTreeNode bis7 =
                new DefaultMutableTreeNode("Fernando I das Duas Sicílias");

        DefaultMutableTreeNode bis8 =
                new DefaultMutableTreeNode("Maria Carolina da Áustria");
    ...
    public static void imprimirArvore(
        ...
        while (filhos.hasMoreElements()) {
            ...
            DefaultMutableTreeNode filho =
                    (DefaultMutableTreeNode) filhos.nextElement();
